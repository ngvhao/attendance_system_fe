...
export default function SelectDate({
  ...
  const [startDate, setStartDate] = useState<Date>(data?.startDate instanceof Date ? data.startDate : new Date());

  const [endDate, setEndDate] = useState<Date>(data?.endDate instanceof Date ? data.endDate : new Date());
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="text-xs text-muted-foreground">Current time: {format(startDate, 'hh:mm a')}</div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="text-xs text-muted-foreground">Current time: {format(endDate, 'hh:mm a')}</div>
        </div>
      </div>
    </div>
  );
